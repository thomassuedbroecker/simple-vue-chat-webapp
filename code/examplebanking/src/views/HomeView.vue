...
function messagesToLines(messages) {
      ...
      messages.forEach(message => {
        if (message.input && message.input.text) {
          ...
          const systemName = message.agentNickname || 'Lendyr';
...
function onLoad(instance) {
      ...
      instance.updateCustomMenuOptions('bot', [{ text: 'Download transcript', handler: doDownload }]);
      instance.updateCustomMenuOptions('agent', [{ text: 'Download transcript', handler: doDownload }]);
...
window.watsonAssistantChatOptions = {
  ...
  serviceDeskFactory: ({callback}) => new MyServiceDesk(callback),
  onLoad: onLoad,
};
